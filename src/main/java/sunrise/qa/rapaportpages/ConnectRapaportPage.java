package sunrise.qa.rapaportpages;
...
public class ConnectRapaportPage extends TestBase{
	...
	@FindBy(xpath= "(//span[contains(@class,'ant-menu-title-content')][normalize-space()='Connect Rapaport'])[1]")
	WebElement connectrapaport;
...
public void navigate_to_module() throws InterruptedException
{
	...
	Thread.sleep(2000);
	action.moveToElement(connectrapaport).click().perform();
}
