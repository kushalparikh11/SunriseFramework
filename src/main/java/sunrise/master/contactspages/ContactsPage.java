...
public class ContactsPage extends TestBase{
	...
	@FindBy(xpath= "//div[@id='rc-tabs-1-panel-3']//button[2]")
	WebElement Save_btn;
	
	@FindBy(xpath= "/html/body/div[1]/section/main/div/div[2]/div[2]/div/div/div/div/div/div[2]/table/tbody/tr[2]/td[9]")
...
public void DataEntry_Without_AllDataEnetered()
{
	try {
		TestUtil.navigate_to_option2(master,contacts,contacts_2);
	...
	Vendor_type.click();
	 ...
	 String record_added = Record_added.getText();
	...
	System.out.println(Common_No_random);
	 Assert.assertEquals( record_added,Common_No_random);
