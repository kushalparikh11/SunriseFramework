...
public class ReferenceMediaPage extends TestBase{
	
	@FindBy(xpath= "//span[normalize-space()='Master']")
	WebElement master; 
	@FindBy(xpath= "(//span[@class='ant-menu-title-content'][normalize-space()='Contacts'])[1]")
	WebElement contacts;
	@FindBy(xpath= "(//span[@class='ant-menu-title-content'][normalize-space()='Reference Media'])[1]")
	WebElement referencemedia;
...
public void navigate_to_module() throws InterruptedException
{
	...
	Thread.sleep(2000);
	action.moveToElement(referencemedia).click().perform();
}
