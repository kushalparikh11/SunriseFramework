...
import sunrise.master.contactspages.CityPage;
...
public class CityPageTest extends TestBase {
	...
	public void Verify_MaximumTab_Message() throws InterruptedException
	{
		citypage.navigate_to_module();
		Thread.sleep(2000);
		Assert.assertTrue(citypage.max_msg_present());
	...
	public void Verify_alltabclosed() throws InterruptedException
	{
		...
		citypage.tab_close();
		Thread.sleep(2000);
		Assert.assertTrue(citypage.welcome_msg.isDisplayed());
	}
